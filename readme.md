...
- [Account linkage](policies/account-linkage) - With Azure AD B2C an account can have multiple identities, local (username and password) or social/enterprise account (such as Facebook or AAD). This Azure AD B2C sample demonstrates how to link existing  account to a social account.
