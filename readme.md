...
|[Email second-factor](policies/signin-email-verification)|For scenarios where you would like users to validate their email via OTP on every sign in.| | [Live demo](policies/signin-email-verification#live-demo)||
