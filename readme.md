...
- [Password reset via Email or Phone verification](policies/pwd-reset-email-exists) - This demonstrates how to verify a user via Email or SMS on a single screen.
